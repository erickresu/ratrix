...
void main() {
  group('buildPayload', () {
    Map<String, dynamic> build({
      ...
      String? expressMarkup,
      String fullChargeCode = 'ABC-123',
      DateTime? expiryDate,
      List<({String origin, String destination, List<String> rates, List<String> expressRates, LocationOption? originOption, LocationOption? destinationOption})> rows = const [],
