...
class RatesColors extends ThemeExtension<RatesColors> {
  ...
  static const light = RatesColors(
    primary: Color(0xFF2CC6A6),
    primaryHover: Color(0xFF22A88C),
    primaryDeep: Color(0xFF1B7A65),
    primaryDeeper: Color(0xFF1E6F5C),
    primarySoftBg: Color(0xFFE4F9F4),
    primaryChipBg: Color(0xFFCFF2EA),
    primaryBorder: Color(0xFFA9E8DA),
    ...
    textMutedStrong: Color(0xFF475569),
    textFaint: Color(0xFF94A3B8),
    success: Color(0xFF65A30D),
    successBg: Color(0xFFECFCCB),
    successText: Color(0xFF3F6212),
    custom: Color(0xFF2563EB),
    customBg: Color(0xFFEFF4FF),
    accent: Color(0xFFD97706),
    accentHover: Color(0xFFB45309),
    accentSoftBg: Color(0xFFFEF3E2),
    accentChipBg: Color(0xFFFCE3BE),
    destructive: Color(0xFFDC2626),
    destructiveSoft: Color(0xFFFF8A8A),
    shadowSoft: Color(0x0F0F172A),
    shadowCard: Color(0x140F172A),
